  ...
  let styles = [
    ...
    ()=>{
      ...
      if(button_gradient?.isWithGradient){
        ...
        styles += colorPropertyStyled(getResponsiveSetting(settings, 'button_background_color', '.state-disabled'), 'background-color')
        styles += 'background-blend-mode: color-burn;'
      }
    ...
    ()=>{
      ...
      if(button_gradient?.isWithGradient){
        ...
        styles += colorPropertyStyled(getResponsiveSetting(settings, 'button_background_color', '.active'), 'background-color')
        styles += 'background-blend-mode: color-burn;'
      }
