        ...
        <div className="document-detail">
          <div className="document-detail_header">
            ...
            <div className="document-detail__btn-nav-group">
              <button onClick={this.props.prevImageDetail} disabled={!this.props.havePreviousImage}
                      className="document-detail__btn-nav">
                <ArrowImageDet style={{transform: 'rotate(-180deg)'}} width={24} height={16}/>
              </button>
              <button onClick={this.props.nextImageDetail} disabled={!this.props.haveNextImage}
                      className="document-detail__btn-nav">
                  ...
                  <form onSubmit={props.handleSubmit}>
                    ...
                    <div className="document-detail__copy-block">
                      <CopyToClipboard text={props.values.url}>
                        <button className="document-detail__btn document-detail__btn-copy-url">Copy URL to clipboard
                        </button>
                      </CopyToClipboard>
                    </div>
                    ...
                    {typeof mediaVariation !== "undefined" ?
                      mediaVariation.map((variation, key) => {
                        ...
                        return <div key={key} className="document-detail__line-to-change"><span
                          className="document-detail__name-of-changes">{variation.name}:</span>
