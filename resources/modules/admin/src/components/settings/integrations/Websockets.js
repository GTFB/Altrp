...
class Websockets extends Component {
  ...
  render() {
    ...
    return (
      <div className="admin_settings_websockets">
        <div className="admin_settings_websockets_box">
          <div className="admin_switcher">
            <div className="admin_switcher__label">Websocket Server</div>
          ...
          <div className="admin_input__label" width="10%">
            <label htmlFor="websockets-port">Port:</label>
          </div>
          ...
          <div className="admin_input__label" width="10%">
            <label htmlFor="websockets-key">Key:</label>
          </div>
          <div className="admin_input">
            <AutoUpdateInput
              type="number"
          ...
          <div className="admin_input__label" width="10%">
            <label htmlFor="websockets-key">Host:</label>
          </div>
          <div className="admin_input">
            <AutoUpdateInput
              type="text"
