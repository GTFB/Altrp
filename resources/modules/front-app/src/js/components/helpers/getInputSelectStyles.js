...
export default function getInputSelectStyles(settings) {
  let styles = [
    ...
    "}",
    ".bp3-icon_text-widget svg, .bp3-icon_text-widget .bp3-icon",
    ...
    "}",
    ".state-disabled .bp3-icon_text-widget.bp3-icon_text-widget svg, .state-disabled .bp3-icon_text-widget.bp3-icon_text-widget .bp3-icon",
    ...
    ["background-color", "input_icons_background", "color", ".active"],
    "}",
    ".active .bp3-icon_text-widget.bp3-icon_text-widget svg, .active .bp3-icon_text-widget.bp3-icon_text-widget .bp3-icon",
