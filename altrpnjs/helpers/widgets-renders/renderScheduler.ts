...
export default function renderScheduler(settings, device) {
  ...
  const titleDate = date.toLocaleString(lang, timeformat) + " " + date.getFullYear() + (lang === "ru" ? " г." : "")
  const ariaLabelDate = date.toLocaleString(lang, timeformat) + (lang === "ru" ? "a" : "") + " " + date.getFullYear() + (lang === "ru" ? " г." : "")
  ...
  return `<div class="popup-wrapper">
             <div class="fc fc-media-screen fc-direction-ltr fc-theme-standard">
                 <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                    ...
                    <div class="fc-toolbar-chunk">
                       <div class="fc-button-group">
                          <button type="button" title="${lang === "ru" ? "День" : "day view"}" aria-pressed="false" class="fc-timeGridDay-button fc-button fc-button-primary">${lang === "ru" ? "День" : "day"}</button>
                          <button type="button" title="${lang === "ru" ? "Неделя" : "week view"}" aria-pressed="false" class="fc-timeGridWeek-button fc-button fc-button-primary">${lang === "ru" ? "Неделя" : "week"}</button>
                          <button type="button" title="${lang === "ru" ? "Месяц" : "month view"}" aria-pressed="true" class="fc-dayGridMonth-button fc-button fc-button-primary fc-button-active">${lang === "ru" ? "Месяц" : "month"}</button>
                       </div>
                    </div>
                 </div>
                                         ...
                                         <tr role="row">
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-mon">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "понедельник" : "Monday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "пн" : "Mon"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-tue">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "вторник" : "Tuesday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "вт" : "Tue"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-wed">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "среда" : "Wednesday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "ср" : "Wed"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-thu">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "четверг" : "Thursday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "чт" : "Thu"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-fri">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "пятница" : "Friday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "пт" : "Fri"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-sat">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "суббота" : "Saturday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "сб" : "Sat"}</a>
                                             </div>
                                           </th>
                                           <th role="columnheader" class="fc-col-header-cell fc-day fc-day-sun">
                                             <div class="fc-scrollgrid-sync-inner">
                                               <a aria-label="${lang === "ru" ? "воскресенье" : "Sunday"}" class="fc-col-header-cell-cushion ">${lang === "ru" ? "вс" : "Sun"}</a>
                                             </div>
                                           </th>
                                         </tr>
                                     </thead>
                                    ...
                                    <div class="fc-daygrid-body fc-daygrid-body-unbalanced " style="width: 1418px;">
                                      <table role="presentation" class="fc-scrollgrid-sync-table" style="width: 1418px; height: 1025px;">
                                        ...
                                        <tbody role="presentation">
                                          <tr role="row">
                                            ${arrayDates.filter((_, idx) => idx + 1 <= 7).map(number => {
                                              return (
