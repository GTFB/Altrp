...
export function getHeadingStyles(settings, id) {
  ...
  const justifyContent = getResponsiveSetting(settings, 'heading_settings_alignment');
  ...
  const justifyContentHeaddingSub = getResponsiveSetting(settings, 'sub_heading_settings_alignment');

  if (justifyContentHeaddingSub) {
    styles += simplePropertyStyled(justifyContentHeaddingSub, 'justify-content');
  }

  const textShadowHeaddingSub = getResponsiveSetting(settings, 'text_shadow_sub_heading');

  if (textShadowHeaddingSub) {
    styles += textShadowControllerToStyles(textShadowHeaddingSub);
  }

  const typographicHeaddingSub = getResponsiveSetting(settings, 'typographic_sub_heading');

  if (typographicHeaddingSub) {
    styles += typographicControllerToStyles(typographicHeaddingSub);
  }

  const paddingHeaddingSub = getResponsiveSetting(settings, 'padding_sub_heading');
  ...
  const backgroundColorHeaddingSub = getResponsiveSetting(settings, 'bg_sub_heading');

  if (backgroundColorHeaddingSub) {
    styles += colorPropertyStyled(backgroundColorHeaddingSub, 'background-color');
  }
  ...
  const justifyContentHeaddingSubHover = getResponsiveSetting(settings, 'sub_heading_settings_alignment', ':hover');

  if (justifyContentHeaddingSubHover) {
    styles += simplePropertyStyled(justifyContentHeaddingSubHover, 'justify-content');
  }

  const textShadowHeaddingSubHover = getResponsiveSetting(settings, 'text_shadow_sub_heading', ':hover');

  if (textShadowHeaddingSubHover) {
    styles += textShadowControllerToStyles(textShadowHeaddingSubHover);
  }

  const typographicHeaddingSubHover = getResponsiveSetting(settings, 'typographic_sub_heading', ':hover');

  if (typographicHeaddingSubHover) {
    styles += typographicControllerToStyles(typographicHeaddingSubHover);
  }

  const paddingHeaddingSubHover = getResponsiveSetting(settings, 'padding_sub_heading', ':hover');

  if (paddingHeaddingSubHover) {
    styles += dimensionsControllerToStyles(paddingHeaddingSubHover);
  }

  const colorHeaddingSubHover = getResponsiveSetting(settings, 'color_sub_heading', ':hover');

  if (colorHeaddingSubHover) {
    styles += colorPropertyStyled(colorHeaddingSubHover, 'color');
  }

  const backgroundColorHeaddingSubHover = getResponsiveSetting(settings, 'bg_sub_heading', ':hover');

  if (backgroundColorHeaddingSubHover) {
    styles += colorPropertyStyled(backgroundColorHeaddingSubHover, 'background-color');
  }

  const widthHeaddingSubHover = getResponsiveSetting(settings, 'width_sub_heading', ':hover');
  ...
  const marginTopHover = getResponsiveSetting(settings, 'spacing_sub_heading', ':hover');
  ...
  const marginBottomHover = getResponsiveSetting(settings, 'spacing_sub_heading', ':hover');
  ...
  const marginRightHover = getResponsiveSetting(settings, 'spacing_sub_heading', ':hover');
  ...
  const marginLeftHover = getResponsiveSetting(settings, 'spacing_sub_heading', ':hover');
  ...
  const textAlignAdvancedWrapper = getResponsiveSetting(settings, 'alignment_advanced_heading_content');
  ...
  const backgroundColorHeadingAdvanced = getResponsiveSetting(settings, 'background_color_advanced_heading_style');

  if (backgroundColorHeadingAdvanced) {
    styles += colorPropertyStyled(backgroundColorHeadingAdvanced, 'background-color');
  }

  const colorHeadingAdvanced = getResponsiveSetting(settings, 'color_advanced_heading_style');

  if (colorHeadingAdvanced) {
    styles += colorPropertyStyled(colorHeadingAdvanced, 'color');
  }

  const paddingHeadingAdvanced = getResponsiveSetting(settings, 'padding_advanced_heading_style');

  if (paddingHeadingAdvanced) {
    styles += dimensionsControllerToStyles(paddingHeadingAdvanced);
  }

  const typographicHeadingAdvanced = getResponsiveSetting(settings, 'typography_advanced_heading_style');

  if (typographicHeadingAdvanced) {
    styles += typographicControllerToStyles(typographicHeadingAdvanced);
  }

  const textShadowHeadingAdvanced = getResponsiveSetting(settings, 'text_shadow_advanced_heading_style');

  if (textShadowHeadingAdvanced) {
    styles += textShadowControllerToStyles(textShadowHeadingAdvanced);
  }

  const borderTypeHeadingAdvanced = getResponsiveSetting(settings, 'border_type_advanced_heading_style');

  if (borderTypeHeadingAdvanced) {
    styles += simplePropertyStyled(borderTypeHeadingAdvanced, 'border-style');
  }

  const borderWidthHeadingAdvanced = getResponsiveSetting(settings, 'border_width_advanced_heading_style');

  if (borderWidthHeadingAdvanced) {
    styles += borderWidthStyled(borderWidthHeadingAdvanced);
  }

  const borderColorHeadingAdvanced = getResponsiveSetting(settings, 'border_color_advanced_heading_style');

  if (borderColorHeadingAdvanced) {
    styles += colorPropertyStyled(borderColorHeadingAdvanced, 'border-color');
  }

  const borderRadiusHeadingAdvanced = getResponsiveSetting(settings, 'border_radius_advanced_heading_style');

  if (borderRadiusHeadingAdvanced) {
    styles += dimensionsControllerToStyles(borderRadiusHeadingAdvanced, 'border-radius');
  }

  const opacityHeadingAdvanced = getResponsiveSetting(settings, 'opacity_advanced_heading_style');
  ...
  const backgroundColorHeadingAdvancedHover = getResponsiveSetting(settings, 'background_color_advanced_heading_style', ':hover');

  if (backgroundColorHeadingAdvancedHover) {
    styles += colorPropertyStyled(backgroundColorHeadingAdvancedHover, 'background-color');
  }

  const colorHeadingAdvancedHover = getResponsiveSetting(settings, 'color_advanced_heading_style', ':hover');

  if (colorHeadingAdvancedHover) {
    styles += colorPropertyStyled(colorHeadingAdvancedHover, 'color');
  }

  const paddingHeadingAdvancedHover = getResponsiveSetting(settings, 'padding_advanced_heading_style', ':hover');

  if (paddingHeadingAdvancedHover) {
    styles += dimensionsControllerToStyles(paddingHeadingAdvancedHover);
  }

  const typographicHeadingAdvancedHover = getResponsiveSetting(settings, 'typography_advanced_heading_style', ':hover');

  if (typographicHeadingAdvancedHover) {
    styles += typographicControllerToStyles(typographicHeadingAdvancedHover);
  }

  const textShadowHeadingAdvancedHover = getResponsiveSetting(settings, 'text_shadow_advanced_heading_style', ':hover');

  if (textShadowHeadingAdvancedHover) {
    styles += textShadowControllerToStyles(textShadowHeadingAdvancedHover);
  }

  const borderTypeHeadingAdvancedHover = getResponsiveSetting(settings, 'border_type_advanced_heading_style', ':hover');

  if (borderTypeHeadingAdvancedHover) {
    styles += simplePropertyStyled(borderTypeHeadingAdvancedHover, 'border-style');
  }

  const borderWidthHeadingAdvancedHover = getResponsiveSetting(settings, 'border_width_advanced_heading_style', ':hover');

  if (borderWidthHeadingAdvancedHover) {
    styles += borderWidthStyled(borderWidthHeadingAdvancedHover);
  }

  const borderColorHeadingAdvancedHover = getResponsiveSetting(settings, 'border_color_advanced_heading_style', ':hover');

  if (borderColorHeadingAdvancedHover) {
    styles += colorPropertyStyled(borderColorHeadingAdvancedHover, 'border-color');
  }

  const borderRadiusHeadingAdvancedHover = getResponsiveSetting(settings, 'border_radius_advanced_heading_style', ':hover');

  if (borderRadiusHeadingAdvancedHover) {
    styles += dimensionsControllerToStyles(borderRadiusHeadingAdvancedHover, 'border-radius');
  }

  const opacityHeadingAdvancedHover = getResponsiveSetting(settings, 'opacity_advanced_heading_style', ':hover');
  ...
  const marginBottomForHorizontal = getResponsiveSetting(settings, 'horizontal_offset_advanced_heading_content');

  if (marginBottomForHorizontal) {
    styles += sizeStyled(marginBottomForHorizontal, 'margin-bottom');
  }

  const marginBottomForVertical = getResponsiveSetting(settings, 'vertical_offset_advanced_heading_content');

  if (marginBottomForVertical) {
    styles += sizeStyled(marginBottomForVertical, 'margin-bottom');
  }

  const marginBottomForRotate = getResponsiveSetting(settings, 'rotate_offset_advanced_heading_content');
  ...
  const marginBottomForHorizontalHover = getResponsiveSetting(settings, 'horizontal_offset_advanced_heading_content', ':hover');

  if (marginBottomForHorizontalHover) {
    styles += sizeStyled(marginBottomForHorizontalHover, 'margin-bottom');
  }

  const marginBottomForVerticalHover = getResponsiveSetting(settings, 'vertical_offset_advanced_heading_content', ':hover');

  if (marginBottomForVerticalHover) {
    styles += sizeStyled(marginBottomForVerticalHover, 'margin-bottom');
  }

  const marginBottomForRotateHover = getResponsiveSetting(settings, 'rotate_offset_advanced_heading_content', ':hover');
  ...
  const typographic = getResponsiveSetting(settings, 'heading_style_typographic');

  if (typographic) {
    styles += typographicControllerToStyles(typographic);
  }

  const textShadow = getResponsiveSetting(settings, 'heading_style_text_shadow');
  ...
  const backgroundColor = getResponsiveSetting(settings, 'style_background_color');
  ...
  const colorHover = getResponsiveSetting(settings, 'heading_style_color', ':hover');

  if (colorHover) {
    styles += colorPropertyStyled(colorHover, 'color');
  }

  const typographicHover = getResponsiveSetting(settings, 'heading_style_typographic', ':hover');

  if (typographicHover) {
    styles += typographicControllerToStyles(typographicHover);
  }

  const textShadowHover = getResponsiveSetting(settings, 'heading_style_text_shadow', ':hover');

  if (textShadowHover) {
    styles += textShadowControllerToStyles(textShadowHover);
  }

  const marginHover = getResponsiveSetting(settings, 'style_position_margin', ':hover');

  if (marginHover) {
    styles += dimensionsControllerToStyles(marginHover, 'margin');
  }

  const paddingHover = getResponsiveSetting(settings, 'style_position_padding', ':hover');

  if (paddingHover) {
    styles += dimensionsControllerToStyles(paddingHover);
  }

  const zIndexHover = getResponsiveSetting(settings, 'position_z_index', ':hover');

  if (zIndexHover) {
    styles += simplePropertyStyled(zIndexHover, 'z-index');
  }

  const backgroundColorHover = getResponsiveSetting(settings, 'style_background_color', ':hover');

  if (backgroundColorHover) {
    styles += colorPropertyStyled(backgroundColorHover, 'background-color');
  }

  const opacityHover = getResponsiveSetting(settings, 'style_background_opacity', ':hover');
  ...
  const borderTypeHover = getResponsiveSetting(settings, 'style_border_type', ':hover');

  if (borderTypeHover) {
    styles += simplePropertyStyled(borderTypeHover, 'border-style');
  }

  const borderWidthHover = getResponsiveSetting(settings, 'style_border_width', ':hover');

  if (borderWidthHover) {
    styles += borderWidthStyled(borderWidthHover);
  }

  const borderColorHover = getResponsiveSetting(settings, 'style_border_color', ':hover');

  if (borderColorHover) {
    styles += colorPropertyStyled(borderColorHover, 'border-color');
  }

  const borderRadiusHover = getResponsiveSetting(settings, 'style_border_radius', ':hover');

  if (borderRadiusHover) {
    styles += sizeStyled(borderRadiusHover, 'border-radius');
  }

  const transformHover = getResponsiveSetting(settings, 'transform_style', ':hover');
  ...
  const backgroundPosition = getResponsiveSetting(settings, 'background_position');

  if (backgroundPosition) {
    styles += simplePropertyStyled(backgroundPosition, 'background-position');
  }

  const backgroundAttachment = getResponsiveSetting(settings, 'background_attachment');
  ...
  const colorAnimating = getResponsiveSetting(settings, 'animated_text_color_headline_animating_style');
  ...
  const typographicAnimatingHover = getResponsiveSetting(settings, 'animated_text_headline_animating_style', ':hover');

  if (typographicAnimatingHover) {
    styles += typographicControllerToStyles(typographicAnimatingHover);
  }

  const colorAnimatingHover = getResponsiveSetting(settings, 'animated_text_color_headline_animating_style', ':hover');
  ...
  const typographicNoAnimating = getResponsiveSetting(settings, 'text_headline_animating_style');

  if (typographicNoAnimating) {
    styles += typographicControllerToStyles(typographicNoAnimating);
  }

  const colorNoAnimating = getResponsiveSetting(settings, 'text_color_headline_animating_style');
  ...
  const typographicNoAnimatingHover = getResponsiveSetting(settings, 'text_headline_animating_style', ':hover');

  if (typographicNoAnimatingHover) {
    styles += typographicControllerToStyles(typographicNoAnimatingHover);
  }

  const colorNoAnimatingHover = getResponsiveSetting(settings, 'text_color_headline_animating_style', ':hover');
  ...
  const strokeWidthAnimatingSvg = getResponsiveSetting(settings, 'width_shape_animating');

  if (strokeWidthAnimatingSvg) {
    styles += sizeStyled(strokeWidthAnimatingSvg, 'stroke-width');
  }

  const colorAnimatingSvg = getResponsiveSetting(settings, 'color_shape_animating');
  ...
  const strokeWidthAnimatingSvgHover = getResponsiveSetting(settings, 'width_shape_animating', ':hover');

  if (strokeWidthAnimatingSvgHover) {
    styles += sizeStyled(strokeWidthAnimatingSvgHover, 'stroke-width');
  }

  const colorAnimatingSvgHover = getResponsiveSetting(settings, 'color_shape_animating', ':hover');
