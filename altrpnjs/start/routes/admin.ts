...
Route.group(() => {
  Route.group(() => {
    ...
    Route.get(
      '/models/:model_id/data_source_options',
    ...
    Route.get(
      '/models/:id/relations/:relationship_id',
      'admin/RelationshipsController.getRelationship'
    );
    Route.put(
      '/models/:id/relations/:relationship_id',
      'admin/RelationshipsController.updateRelationship'
    );
    Route.delete(
      '/models/:id/relations/:relationship_id',
      'admin/RelationshipsController.deleteRelationship'
    );
    Route.get(
      '/models/:id/data_source_options',
      'admin/ModelsController.getDataSourcesOptionsByModel'
    );
    ...
    Route.get('/models_options', 'admin/ModelsController.models_options').name =
      'admin.models_options';
    ...
    Route.get('/settings/:setting_name', 'admin/SettingsController.getSettings').name =
      'admin.settings.get';
    Route.put('/settings/:setting_name', 'admin/SettingsController.saveSettings').name =
      'admin.settings.save';

    //@todo: move this method to another place?
    Route.post('/settings/reset', 'admin/SettingsController.resetSettings').name =
      'admin.settings.reset';

    Route.post('/update_altrp', 'admin/AdminController.update_altrp').name = 'admin.update_altrp';
    Route.post('/install_test_altrp', 'admin/AdminController.install_test_altrp').name =
      'admin.install_test_altrp';
     ...
     */
    Route.post('update-all-resources', 'admin/AdminController.upgradeAllResources').name =
      'admin.update-all-resources';
    ...
    for (const method of methods) {
      ...
      Route[method]('plugins-handlers/*', async (httpContext: HttpContextContract) => {
        ...
        const fileName = app_path(
          `AltrpPlugins/${plugin.name}/request-handlers/admin/${method}/${segments[4]}.${
            isProd() ? 'js' : 'ts'
          }`
        );
