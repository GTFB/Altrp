...
class EditNotification extends Component {
  constructor(props) {
    ...
    this.resource = new Resource({
      route: `/admin/ajax/users/${this.state.user_id}/notifications/${this.state.notice_id}`
    });
    this.resourceEdit = new Resource({
      route: `/admin/ajax/users/${this.state.user_id}/notifications`
    });
    this.dataSources = new Resource({
      route: "/admin/ajax/data_source_options"
    });
      ...
      case "parent":
        this.setState(s => ({
          ...
          value: {
            ...
            name: name,
            notice_settings: {
              ...s.value.notice_settings,
              notice_name: titleToName(name)
            }
          }
        }));
        break;
      ...
      <div className="wrapper">
        ...
        <div className="admin-notice-box-parent">
          <button
            ...
            onClick={() => this.saveNoticeSetting()}
          >
            Save and Add New
          </button>
          <div className="admin-notice-general">
            ...
            <div className="form-group">
              ...
              <input
                ...
                id="name"
                name="name"
                value={notice_settings?.notice_name ?? ""}
                onChange={e => {
                  this.changeInput(e, "notice");
                }}
                className="form-control"
              />
            </div>
