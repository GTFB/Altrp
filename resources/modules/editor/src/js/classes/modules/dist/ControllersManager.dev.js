...
exports["default"] = exports.CONTROLLER_SELECT2 = exports.CONTROLLER_SLIDER = exports.CONTROLLER_CHOOSE = exports.CONTROLLER_SELECT = exports.CONTROLLER_SWITCHER = exports.CONTROLLER_NUMBER = exports.CONTROLLER_TEXT = exports.CONTROLLER_TEXTAREA = exports.TAB_ADVANCED = exports.TAB_STYLE = exports.TAB_CONTENT = void 0;
    ...
    value: function getElementControl(elementName, controlId) {
      ...
      for (var tabName in controls) {
        if (controls.hasOwnProperty(tabName)) {
          ...
          try {
            for (var _iterator = controls[tabName][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
