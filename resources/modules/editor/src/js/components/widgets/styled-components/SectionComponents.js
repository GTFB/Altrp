...
const settingsToStyles = ({settings, columns = []})=>{
  ...
  let flexWrap, align, justifyContent, flexDirection, minHeight, overflow, backgroundColor, borderStyle, borderWidth, borderColor, borderRadius, boxShadow;
  ...
  let flexWrapH, alignH, justifyContentH, flexDirectionH, minHeightH, overflowH, backgroundColorH, borderStyleH, borderWidthH, borderColorH, borderRadiusH, boxShadowH;
  ...
  if (settings !== undefined) {
    minHeightH = getResponsiveSetting(settings, 'label_style_min_height', ':hover');
  }
  ...
  if (settings !== undefined) {
    backgroundColorH = getResponsiveSetting(settings, 'section_style_background_color', ':hover');
  }
  ...
  if (settings !== undefined) {
    borderStyleH = getResponsiveSetting(settings, 'section_style_border_type', ':hover');
  }
  ...
  if (settings !== undefined) {
    borderWidthH = getResponsiveSetting(settings, 'section_style_border_width', ':hover');
  }
  ...
  if (settings !== undefined) {
    borderColorH = getResponsiveSetting(settings, 'section_style_border_color', ':hover');
  }
  ...
  if (settings !== undefined) {
    borderRadiusH = getResponsiveSetting(settings, 'section_style_border_radius', ':hover');
  }
  ...
  if (settings !== undefined) {
    boxShadowH = getResponsiveSetting(settings, 'section_style_box_shadow', ':hover');
  }
  ...
  if (width) {
    styles += `padding-left: calc((100vw - ${width.size + width.unit}) / 2); padding-right: calc((100vw - ${width.size + width.unit}) / 2); width: 100vw; `;
  }
  ...
  if (widthH) {
    styles += `padding-left: calc((100vw - ${widthH.size + widthH.unit}) / 2); padding-right: calc((100vw - ${widthH.size + widthH.unit}) / 2); width: 100vw; `;
  }
  ...
  let backgroundImageH, backgroundPositionH, backgroundAttachmentH, backgroundRepeatH, backgroundSizeInUnitsH, backgroundSizeH;
  ...
  if (settings !== undefined) {
    marginH = getResponsiveSetting(settings, 'position_style_position_margin', ':hover');
  }
