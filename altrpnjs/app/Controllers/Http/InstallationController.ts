...

{
   ...
   */
    systemCompatibility( Request $request )
  {
    // Begin check
   ...
   * @return array
   */
  private  getSystemCompatibilitiesData()
  {
    return [
      [
        'type' : 'requirement',
      ...
      [
        'type' : 'requirement',
        'name' : 'PHP GD Library',
        'check' : ( extension_loaded( 'gd' ) && _exists( 'gd_info' ) ),
   ...
   * @return bool
   */
  private  checkSystemCompatibility( $request, $compatibilities )
  {
    ...
    if (
      ( file_exists( storage_path( 'app//app' ) ) &&
        is_dir( storage_path( 'app//app' ) ) &&
        ( is_writable( storage_path( 'app//app' ) ) ) &&
        getPerms( storage_path( 'app//app' ) ) >= 755 )
      &&
      ( file_exists( storage_path( 'app//app/logo' ) ) &&
        is_dir( storage_path( 'app//app/logo' ) ) &&
        ( is_writable( storage_path( 'app//app/logo' ) ) ) &&
        getPerms( storage_path( 'app//app/logo' ) ) >= 755 )
      &&
      ( file_exists( storage_path( 'app//app/page' ) ) &&
        is_dir( storage_path( 'app//app/page' ) ) &&
        ( is_writable( storage_path( 'app//app/page' ) ) ) &&
        getPerms( storage_path( 'app//app/page' ) ) >= 755 )
      &&
      ( file_exists( storage_path( 'app//files' ) ) &&
        is_dir( storage_path( 'app//files' ) ) &&
        ( is_writable( storage_path( 'app//files' ) ) ) &&
        getPerms( storage_path( 'app//files' ) ) >= 755 )
    ) {
