      ...
      Edge({
        ...
        url:
          Env.get('PATH_ENV') === 'production'
            ...
            : 'http://localhost:3002/src/admin.js',
      })
    );
  }
  async customizer({ view }) {
    return view.render(
      ...
      Edge({
        ...
        url:
          Env.get('PATH_ENV') === 'production'
            ? '/modules/customizer/customizer.js'
            : 'http://localhost:3002/src/customizer.js',
      })
    );
  }
  ...
  public robot({ view }) {
    return view.render(
      ...
      Edge({
        ...
        url:
          Env.get('PATH_ENV') === 'production'
            ? '/modules/robots/robots.js'
            : 'http://localhost:3006/src/bundle.js',
