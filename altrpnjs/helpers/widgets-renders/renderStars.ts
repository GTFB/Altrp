...
${count.map(star => `<li class="${"altrp-stars-star altrp-stars-visual" + star}" style="cursor: pointer;"><svg style="transition: none;" data-icon="star-empty" width="20" height="20" viewBox="0 0 20 20">
