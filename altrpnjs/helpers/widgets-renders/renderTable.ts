...
export default function renderTable(settings, device, ) {
  ...
  //           ${tableColumns.map(el => `
  //             <div colspan="1" role="columnheader" class="altrp-table-th altrp-table-cell" style="text-align: ${el.column_header_alignment || 'center'}; background-color: ${el?.header_bg?.colorPickedHex};">
